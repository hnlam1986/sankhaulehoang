...
{
    public partial class ListCateVideo : System.Web.UI.UserControl
    {
        ...
        {
            SqlParameter key = new SqlParameter("CateID", CateID);
            DataSet ds = DataAccessLayer.ExecuteDataSet("Video_Get5VideoByCate", key);
