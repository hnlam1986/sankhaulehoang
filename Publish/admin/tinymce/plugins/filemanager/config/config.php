...
$base_url="";  // base url of site. If you prefer relative urls leave empty
$upload_dir = '/Admin/UserFiles/'; // path from base_url to base of upload folder
$current_path = '../../../UserFiles/'; // relative path from filemanager folder to upload folder
